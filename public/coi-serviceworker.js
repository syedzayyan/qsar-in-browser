 ...
 *
 *  GitHub Pages can't set Cross-Origin-Opener-Policy / Cross-Origin-Embedder-Policy
 *  headers, but SharedArrayBuffer (needed by dmpnn_wasm's rayon thread pool)
 *  requires the page to be cross-origin isolated. This service worker fakes
 *  those response headers client-side so crossOriginIsolated becomes true
 *  without any server-side header support.
 */
