 ...
 * @returns {any}
 */
export function model_train_kfold(handle, mol_atom_features, mol_n_atoms, mol_edge_index, mol_n_dir_edges, mol_edge_attr, labels, n_splits, epochs_per_fold, lr) {
    ...
    const ret = wasm.model_train_kfold(handle, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, n_splits, epochs_per_fold, lr);
    return ret;
}
